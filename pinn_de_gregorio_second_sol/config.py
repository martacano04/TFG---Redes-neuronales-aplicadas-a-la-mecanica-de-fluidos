...
def get_args():
    ...
    parser.add_argument("--first_sol_dir", type=str, required=True, 
                        help="Ruta a la carpeta de resultados de la primera solución (ej: results/run_001)")
    parser.add_argument("--orth_factor", type=float, default=20.0, help="Factor multiplicador de la ortogonalidad")
    ...
    parser.add_argument("--k_orth", type=float, default=5.0, help="Peso de la condición de ortogonalidad (g3)")
