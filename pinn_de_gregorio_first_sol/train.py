...
def train():
    ...
    milestones = [(8e-06, 0.0002), (5e-07, 8e-05), (7e-09, 0.0)]
    current_m_idx = 0
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        loss_f, loss_c, loss_s, f1, c_val = compute_losses(model, xi, xi_0, xi_pm1, xi_1, device)
        
        total_loss = loss_f + args.k_c * loss_c + args.k_s * loss_s
